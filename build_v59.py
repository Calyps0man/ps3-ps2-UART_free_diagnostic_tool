"""Reproducible Calyps0 V59 diagnostic patch from V47.
...
def main():
    ...
    outputs=[]
    for name,entry,hook in [('Calyps0_V59_display_preflight',a.labels['preflight'],0x89c),('Calyps0_V59_Stable_EE_Tests',a.labels['real'],0x89c)]:
